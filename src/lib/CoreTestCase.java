...
public class CoreTestCase extends TestCase {
    ...
    protected void setUp() throws Exception
    {
        ...
        this.startDriverByPlatformEnv(capabilities); //в зависимости от типа платформы iOs или Android, запускается нужны тип драйвера
    ...
    private DesiredCapabilities getCapabilitiesByPlatformEnv() throws Exception {
        ...
        if (platform.equals(PLATFORM_ANDROID)) {
            ...
            capabilities.setCapability("app", "/Users/uspeh/Desktop/JavaAppiumAutomation/JavaAppiumAutomation/apks/Wikipedia.app");
        } else {
